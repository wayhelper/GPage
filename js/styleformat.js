...
function applyLanguage() {
    ...
    if (settingsModal) {
        ...
        id_auth = document.getElementById('id-auth'),
        id_lang = document.getElementById('id-lang'),
        id_top = document.getElementById('id-top'),
        id_bg = document.getElementById('id-bg');
